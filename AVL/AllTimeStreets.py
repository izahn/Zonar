...
allname2_1 = "C:\\atlas_shared\\AVL\\ZonarHistoricalCSV\\AllTime\\Street\\Temp\\" + allname + "_1" + ".csv"
allname2_2 = "C:\\atlas_shared\\AVL\\ZonarHistoricalCSV\\AllTime\\Street\\Temp\\" + allname + "_2" + ".csv"
allname2 = "C:\\atlas_shared\\AVL\\ZonarHistoricalCSV\\AllTime\\Street\\Temp\\" + allname + "_5" + ".csv"
allname3 = "C:\\atlas_shared\\AVL\\ZonarHistoricalCSV\\AllTime\\Street\\" + allname + "" + ".csv"
csv_url1 = "http://col2225.zonarsystems.net/interface.php?action=showposition&logvers=3.6&username=gisadmins&password=admin1234&operation=path&format=csv&version=2&location=Street%20-%20Grissum" + "&starttime=" + tstarttime + "&endtime=" + tendtime
csv_url2 = "http://col2225.zonarsystems.net/interface.php?action=showposition&logvers=3.6&username=gisadmins&password=admin1234&operation=path&format=csv&version=2&location=Street%20Sweepers%20-%20Grissum" + "&starttime=" + tstarttime + "&endtime=" + tendtime
urllib.urlretrieve(csv_url1, allname2_1)
urllib.urlretrieve(csv_url2, allname2_2)

f = allname2_1
csvinputs = [allname2_2]
